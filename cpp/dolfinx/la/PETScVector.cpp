...
{
  return la::create_petsc_vector(map.comm(), map.local_range(), bs,
                                 map.ghosts());
}
//-----------------------------------------------------------------------------
Vec la::create_petsc_vector(
    MPI_Comm comm, std::array<std::int64_t, 2> range, int bs,
...
PETScVector::PETScVector(
    ...
    : _x(la::create_petsc_vector(comm, range, bs, ghost_indices))
{
  // Do nothing
}
//-----------------------------------------------------------------------------
